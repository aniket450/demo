function cs = float_configuration()
%---------------------------------------------------------------------------
%  MATLAB function for configuration set generated on 11-Dec-2018 10:36:27
...
% Original configuration set target is ert_shrlib.tlc
try
...
cs.set_param('MaxStackSize', '8192');   % Maximum stack size (bytes)
...
% cs.set_param('Toolchain', 'VisualDSP 5.0 | gmake makefile (64-bit Windows)');   % Toolchain
cs.set_param('BuildConfiguration', 'Faster Runs');   % Build configuration
cs.set_param('ObjectivePriorities', {'Execution efficiency','RAM efficiency','ROM efficiency'});   % Prioritized objectives
...
% cs.set_param('CodeReplacementLibrary', 'SHARC code replacement libarary');   % Code replacement library
...
% cs.set_param('ERTDataHdrFileTemplate', 'bose_ert_code_template.cgt');   % Header file template
% cs.set_param('ERTDataSrcFileTemplate', 'bose_ert_code_template.cgt');   % Source file template
% cs.set_param('ERTHdrFileBannerTemplate', 'bose_ert_code_template.cgt');   % Header file template
% cs.set_param('ERTSrcFileBannerTemplate', 'bose_ert_code_template.cgt');   % Source file template
